...
import cn.edu.fudan.violation.exception.ParseFileException;
...
public class IssuePersistenceManager {
    ...
    public void persistScanData(IssueStatistics issueStatistics, String repoUuid) throws ParseFileException {
