...
import cn.edu.fudan.violation.domain.dbo.ScanResult;
import cn.edu.fudan.violation.domain.enums.IgnoreTypeEnum;
...
public class IssueStatistics {
    ...
    @Autowired
    public IssueStatistics(IssueDao issueDao, CommitDao commitDao, IssueAnalyzerDao issueAnalyzerDao, RawIssueDao rawIssueDao) {
        IssueStatistics.issueDao = issueDao;
        IssueStatistics.commitDao = commitDao;
        IssueStatistics.issueAnalyzerDao = issueAnalyzerDao;
