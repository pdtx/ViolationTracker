...
public class DiffLines {
    ...
    public static DiffLines analyzeDiffLines(String preAbsoluteFilePath, String curAbsoluteFilePath) throws IOException {
        ...
        List<String> original = FileUtils.readLines(new File(preAbsoluteFilePath), Charset.defaultCharset());
        List<String> revised = FileUtils.readLines(new File(curAbsoluteFilePath), Charset.defaultCharset());
