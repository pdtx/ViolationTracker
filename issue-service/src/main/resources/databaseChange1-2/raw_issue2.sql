...
--
-- Table structure for table `raw_issue`
--
...
(
    ...
    `issue_uuid` varchar(36)  DEFAULT NULL,
    ...
    KEY          `idx_rawIssue_repo_id` (`repo_uuid`) USING BTREE,
    KEY          `idx_rawIssue_issue_id` (`issue_uuid`) USING BTREE,
    KEY          `idx_rawIssue_category` (`tool`) USING BTREE,
    KEY          `idx_uuid_commit_status` (`uuid`, `tool`, `repo_uuid`) USING BTREE,
    KEY          `idx_category_repoId` (`tool`, `repo_uuid`) USING BTREE,
    KEY          `idx_rawIssue_repo_id_category` (`repo_uuid`, `tool`) USING BTREE
) ENGINE = InnoDB
...
--
-- Dumping data for table `raw_issue`
--

LOCK
TABLES `raw_issue` WRITE;
/*!40000 ALTER TABLE `raw_issue`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `raw_issue`
    ENABLE KEYS */;
UNLOCK
