...
(
    ...
    `repo_id`          varchar(36) NOT NULL COMMENT '扫描的repo文件id',
    ...
    `developer`        text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '本次commit的提交者',
