...
import cn.edu.fudan.violation.mapper.LocationMapper;
...
public class LocationDao {
    ...
    public List<Location> getLocationsByRawIssues(List<String> rawIssueIds){
        if(rawIssueIds == null || rawIssueIds.isEmpty()){
            return new ArrayList<>();
        }
        return locationMapper.getLocationsByRawIssues(rawIssueIds);
    }
