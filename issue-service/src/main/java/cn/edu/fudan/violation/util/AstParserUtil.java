...
//    public static boolean checkMethodOrFieldExist(BaseAnalyzer baseAnalyzer, String filename, List<Location> locations) {
//        int size = locations.size(), num = 0;
//        Set<String> methodNameAndOffset = getAllMethodAndFieldName(baseAnalyzer, filename);
//        for (Location location : locations) {
//            if (methodNameAndOffset.contains(location.getAnchorName())) {
//                num++;
//            }
//        }
